...
{
    public int GUIHorizontalOffset = 0;
    public int GUIVerticalOffset = 0;
    ...
    void OnGUI()
    {
        ...
        GUILayout.BeginArea(new Rect(GUIHorizontalOffset, GUIVerticalOffset, 220, getReal3D.GUI.height));
